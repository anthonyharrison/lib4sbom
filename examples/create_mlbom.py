...
my_package.set_licensedeclared("Apache-2.0")
my_package.set_description("ResNet (Residual Network) is a convolutional neural network that democratized the concepts of residual learning and skip connections. This enables to train much deeper models.")
# Define model card
...
mlmodel_data.set_governance(owner={"organization":"microsoft", "contact" : "sales@microsoft.com"})
mlmodel_data.set_governance(owner={"organization":"microsoft", "contact" : "consulting@microsoft.com"})
