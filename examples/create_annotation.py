...
from lib4sbom.data.annotation import SBOMAnnotation
...
# Annotation
sbom_annotations = []
my_annotation = SBOMAnnotation()
my_annotation.set_annatator("organization", "Acme. Inc", "help@acme.com")
# Create packages
sbom_packages = {}
...
my_annotation.initialise()
my_annotation.add(my_package.get_name(), "This component has known defects.")
sbom_annotations.append(my_annotation.get_annotation())
...
my_annotation.initialise()
my_annotation.add(my_package.get_name(), "This component is subject to change.")
sbom_annotations.append(my_annotation.get_annotation())
# Generate SBOM
my_sbom = SBOM()
...
my_sbom.add_annotations(sbom_annotations)
