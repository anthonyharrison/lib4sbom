...
### Example to show use of lib4sbom to create a SPDX SBOM in JSON=LD format
...
# Generate SBOM
my_sbom = SBOM()
my_sbom.set_type(sbom_type="spdx3")
my_doc = SBOMDocument()
...
#
#
my_generator = SBOMGenerator(False, sbom_type="spdx3", format="json")
